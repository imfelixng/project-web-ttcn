          ...
          <div className="main-section">
            <div className="container">
              <div className="row">
                ...
                <div className="col-lg-6 profile-question">
                  <div class="post-bar ">
                ...
                <div class="col-lg-3 pd-right-none no-pd sidebar-right">
                  <div class="right-sidebar profile-question">
                    <div class="suggestions full-width">
                      <div class="sd-title">
                        <img class="sidebar__icon" src="/images/ic_top_questions.png" alt="icon"/>
                        <h3>Câu hỏi đã lưu</h3>
                      </div>
                      <div class="suggestions-list">
                        <div class="suggestion-usd">
                          <img class="suggestion-usd__avatar" src="/images/users/img_avatar_default.png" alt="logo"/>
                          <div class="sgt-text">
                          <h4><a class="name-question" href="/questions/q_1545927330671u_1545923833901">gfgfgdvghh</a></h4>
                          <span>Nguyễn Quang An</span>
                          <div class="like-cmt">
                            <a><i class="fa fa-heart"><span>2</span></i></a>
                            <a><i class="fa fa-comment"><span>5</span></i></a>
                          </div>
                          </div>
                        </div>
                      </div>
